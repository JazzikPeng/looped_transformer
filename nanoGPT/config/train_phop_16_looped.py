...
model_output_name = 'ckpt_2_0_4.pt' # ckpt_<base_block_size>_<loop_start>_<num_loops>.pt
...
wandb_run_name = 'phop-16-4M-looped_2_0_4' # <base_block_size>_<loop_start>_<num_loops>.pt
